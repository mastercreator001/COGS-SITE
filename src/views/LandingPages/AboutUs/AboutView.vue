      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <h1 class="text-white">
              Welcome Back to <span class="text-white" id="typed"></span>
            </h1>
            ...
            <p class="lead mb-4 text-white opacity-8">
              We’re Always wanting you to come back and contribute to the site, so please send photos stories by the links below
            </p>
