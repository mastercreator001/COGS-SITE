        ...
        <div class="row">
          <div class="col-lg-7 text-center mx-auto position-relative">
            <h1
              ...
              style="display:inline-block;background-color: rgba(3,3,3,0.2);padding: 2px;"
            
            > Wellington Road <P></P> C Of E Middle School
            </h1>
            <p class="lead text-white px-5 mt-3" style="font-weight:700;background-color: rgba(3,3,3,0.2);padding:2px">
